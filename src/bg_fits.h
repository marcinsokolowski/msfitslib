...
public :
  ...
  static int WriteMultiImageFits( vector<CBgFits*> image_list, const char* fits_file, double fFirstChCenterFreq=0.00, double fChannelWidthMHz=0.04, int bWriteKeys=1 );
